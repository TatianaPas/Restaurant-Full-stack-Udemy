...
namespace UdemyRestaurantProject.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if(!await _roleManager.RoleExistsAsync(SD.KitcheRole))
                {
                    await _roleManager.CreateAsync(new IdentityRole(SD.KitcheRole));
